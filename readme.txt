Instructions:
 ...
 - The 'scripts' folder contains the scripts used to generate plots in the paper. It should be possible to run them after extracting data.
   ...
   - mnist_5layer_dw.py generates the images used to create figure 5 and saves it as the files mnist_5layer_dW__mlff.png, mnist_5layer_dW__swni.png, and mnist_5layer_dW__leg.png.
 - Generated figures are saved to the 'out' folder as <name>.pdf where <name>.
